...
// const web3 = new Web3(new GSNProvider(`https://ropsten.infura.io/v3/25f26b1442fe4c729e21ac5a4deb9038`));
 const HDWalletProvider = require('truffle-hdwallet-provider');
// const infuraKey = "25f26b1442fe4c729e21ac5a4deb9038";
//
// const fs = require('fs');
 ...
 const configNetwork = (network, networkId, path = "m/44'/60'/0'/0/", gas = 5500000, gasPrice = 1e10) => ({
